...
int main(int argc, char ** argv) {
    ...
    switch (sortcase) {
        ...
        case 1:
            ...
            ptiSparseTensorSortIndexCustomOrder(&X, mode_order, 1, 1);
            break;
        case 2:
        ...
        case 3:
             ...
             */
            ptiSparseTensorMixedOrder(&X, sb_bits, sk_bits, 1);
            break;
        case 4:
    ...
    if(cuda_dev_id == -2 || cuda_dev_id == -1) {
        ...
        double aver_time = ptiPrintAverageElapsedTime(timer, niters, "GPU SpTns MTTKRP");
    }
    ptiFreeTimer(timer);
